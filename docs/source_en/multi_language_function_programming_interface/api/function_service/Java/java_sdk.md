...
Stream handler provided by the function runtime. Users can directly call the `write()` method after obtaining the Stream object via `context.getStream()`. The runtime automatically completes all necessary context setup.

### Interface description

#### public void write(JsonObject jsonObject)

Stream a JSON object to the client.

- Parameters:

   - **jsonObject** (JsonObject) - The JSON object to be written. It will be serialized to a JSON string internally before sending.
